...
public class Managemenu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView = (ListView)findViewById(R.id.listmanagemenu);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        openHelper = new DatabaseHelper(this);
        menuModelArrayList = openHelper.getAllMenu();
        CustomAdapterManMenu customAdapter = new CustomAdapterManMenu(this, menuModelArrayList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Managemenu.this,EditmenuActivity.class);
                intent.putExtra("menu", menuModelArrayList.get(position));
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Managemenu.this,InputmenuActivity.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.managemenu, menu);
        return true;
    }
